...
const connectionMethods = [
  ...
  },
  {
    ...
    description: "Use a MariaDB connection string",
    icon: Code,
    security: "SSL encryption",
  },
  {
...
export default function MariaDBIntegrationPage() {
  return (
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="flex items-center gap-4">
          <div className="w-16 h-16 bg-white rounded-lg flex items-center justify-center border shadow-sm">
            <Image
              src="/images/integrations/mariadb.png"
              alt="MariaDB logo"
              width={48}
              height={48}
          ...
          <div>
            <h1 className="text-4xl font-bold tracking-tight">MariaDB</h1>
            <p className="text-xl text-muted-foreground">
              Query your MariaDB database using natural language instead of SQL
            </p>
          </div>
        </div>
          ...
          <CardContent className="pt-6">
            <ul className="space-y-3">
              <li className="flex items-start gap-3">
                ...
                <div>
                  <p className="font-medium">MariaDB Database</p>
                  <p className="text-sm text-muted-foreground">
                    A running MariaDB instance (version 10.2 or higher) with your data
                  </p>
                </div>
              </li>
              <li className="flex items-start gap-3">
      ...
      <div className="space-y-6">
        ...
        <div className="space-y-4">
          <div className="flex items-center gap-3">
            ...
            <h3 className="text-xl font-semibold">Access MariaDB Integration</h3>
          </div>
            ...
            <CardContent className="pt-6">
              <div className="space-y-4">
                ...
                <div className="rounded-lg overflow-hidden border">
                  <Image
                    src="/images/docs/mariadb-connect.png"
                    alt="MariaDB connect screen on Datapad UI"
                    width={800}
                    height={400}
          ...
          <Card>
            <CardContent className="pt-6">
              <div className="space-y-4">
                ...
                <div className="rounded-lg overflow-hidden border">
                  <Image
                    src="/images/docs/mariadb-cs.png"
                    alt="MariaDB connection string form in Datapad"
                    width={800}
                    height={400}
                    className="w-full h-auto"
                  />
                ...
                <Alert>
                  ...
                  <AlertDescription>
                    The MariaDB connection string format is: mariadb://USERNAME:PASSWORD@HOST:PORT/DATABASE_NAME
                  </AlertDescription>
                </Alert>
              </div>
            </CardContent>
          ...
          <Card>
            <CardContent className="pt-6">
              <div className="space-y-4">
                ...
                <div className="rounded-lg overflow-hidden border">
                  <Image
                    src="/images/docs/mariadb-form.png"
                    alt="MariaDB connection form in Datapad"
                    width={800}
                    height={400}
                    className="w-full h-auto"
                  />
            ...
            <div className="space-y-4">
              <div>
                ...
                <ul className="text-sm text-muted-foreground space-y-1 ml-4">
                  ...
                  <li>• Ensure MariaDB is accepting connections</li>
              ...
              <div>
                ...
                <ul className="text-sm text-muted-foreground space-y-1 ml-4">
                  ...
                  <li>• Ensure user can connect from external hosts ('%' wildcard)</li>
                  <li>• Try connecting with the same credentials using mariadb client</li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="text-sm text-muted-foreground space-y-1 ml-4">
                  <li>• Verify SSL is enabled on your MariaDB server</li>
                  <li>• Check if you have valid SSL certificates</li>
                  <li>• Try different SSL modes (REQUIRED, PREFERRED, DISABLED)</li>
