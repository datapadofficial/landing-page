      ...
      <section className="py-32">
        <div className="container">
          ...
          <div className="mx-auto max-w-7xl">
                ...
                <div className="flex flex-wrap gap-2">
                  {featuredPost.tags && featuredPost.tags.length > 0 ? (
                    featuredPost.tags.slice(0, 2).map((tag) => (
                      <Badge key={tag} variant="secondary" className="shrink">
                        {tag}
                      </Badge>
                    ))
                  ) : (
            ...
            {otherPosts.length > 0 && (
              <>
                <p className="text-2xl font-medium md:text-3xl">Latest Posts</p>

                {/* Posts List Section - Based on blog29.tsx */}
                <section className="mt-8 space-y-6">
                  {otherPosts.slice(0, 10).map((post, index) => (
                    <React.Fragment key={post.slug}>
                      <Card className="border-none shadow-none">
                        <CardContent className="">
                          <div className="relative w-full">
                            ...
                            <h3 className="mt-2 text-lg font-medium tracking-tight text-foreground md:text-2xl">
                              <Link
                                href={`/blog/${post.slug}`}
                                className="hover:text-primary transition-colors"
                              >
                      ...
                      {index < otherPosts.slice(0, 10).length - 1 && (
