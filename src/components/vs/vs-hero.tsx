...
interface VsHeroProps {
  ...
  badgeText?: string;
  competitorLogoContainerClassName?: string;
}
...
const VsHero = ({
  ...
  return (
    <section className={cn("py-20 bg-background relative overflow-hidden")}>
        ...
        <div className="flex flex-col items-center gap-12">
          ...
          <div className="flex items-center justify-center gap-16 w-full max-w-6xl relative px-8 md:px-16">
            ...
            <div className="flex-shrink-0 p-4">
              <div
                className={cn(
                  "w-32 h-32 md:w-40 md:h-40 rounded-3xl  flex items-center justify-center shadow-2xl border border-input rotate-12",
                  competitorLogoContainerClassName ??
