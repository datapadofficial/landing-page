...
// Integration data - this could be moved to a separate file or fetched from an API
const integrationCategories = [
  {
    ...
    integrations: [
      ...
      },
      {
        ...
        href: "/docs/integrations/google-searchconsole",
        logo: "/images/integrations/google-searchconsole.png",
      },
      {
        name: "Mixpanel",
        href: "/docs/integrations/mixpanel",
        logo: "/images/integrations/mixpanel.png",
      },
      {
        name: "Metabase",
        href: "/docs/integrations/metabase",
        logo: "/images/integrations/metabase.png",
      },
    ],
  },
  {
    ...
    integrations: [
      {
        ...
        href: "/docs/integrations/google-mybusiness",
        logo: "/images/integrations/google-mybusiness.png",
      },
      {
        name: "LinkedIn",
        href: "/docs/integrations/linkedin-social",
        logo: "/images/integrations/linkedin-social.png",
      },
      {
        name: "Instagram Business",
        href: "/docs/integrations/instagram-business",
        logo: "/images/integrations/instagram-business.png",
      },
      {
        name: "Facebook Page",
    ...
    integrations: [
      {
        ...
        popular: true,
        logo: "/images/integrations/postgres.png",
      },
      {
        name: "MongoDB",
      ...
      {
        name: "MySQL",
        href: "/docs/integrations/mysql",
        logo: "/images/integrations/mysql.png",
      },
      {
      ...
      },
      {
        ...
        href: "/docs/integrations/google-bigquery",
        logo: "/images/integrations/google-bigquery.png",
      },
    ],
  },
  {
    ...
    integrations: [
      {
        ...
        popular: true,
        logo: "/images/integrations/google-ads.png",
      },
      {
        name: "Facebook Ads",
        href: "/docs/integrations/facebook-ads",
        popular: true,
        logo: "/images/integrations/facebook-ads.png",
      },
      {
        name: "LinkedIn Ads",
        href: "/docs/integrations/linkedin-ads",
        logo: "/images/integrations/linkedin-ads.png",
      },
      {
        name: "TikTok Ads",
        href: "/docs/integrations/tiktok-ads",
        logo: "/images/integrations/tiktok-ads.png",
      },
    ],
  },
  {
...
export function IntegrationSearch({ placeholder }: { placeholder: string }) {
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Learn how to connect your data sources and get the most out of your
          integrations
        </CardDescription>
      </CardHeader>
      <CardContent>
...
export function GetStartedButton({
  ...
  return (
    <div className="mt-6">
      <Button asChild size="lg" className="gap-2 mt-6 text-white">
        <Link href={href}>
          <ArrowRight className="h-4 w-4" />
          <span className="text-lg mt-3 text-white">{children}</span>
        </Link>
      </Button>
    </div>
  );
