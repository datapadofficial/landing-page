...
const Feature128 = () => {
  return (
    <section className="container py-32">
      <div className="border bg-black-3 dark:bg-white-3 m-auto rounded-3xl px-8 pb-8 pt-14 text-center md:px-16 md:pb-16 md:pt-24">
        <h2 className="mx-auto mb-4 max-w-96 text-3xl font-normal md:max-w-4xl md:text-5xl">
        ...
        <div className="mt-16 grid w-full grid-cols-2 md:grid-cols-6">
          {items.map((item, index) => (
            <div
              key={index}
              className="group relative flex w-full flex-col items-center justify-center gap-4 px-3 py-6 md:gap-6 md:px-4 md:py-4 border-black-10 dark:border-white-10 border-r border-b last:border-r-0 [&:nth-child(2n)]:border-r-0 md:[&:nth-child(2n)]:border-r md:[&:nth-child(6n)]:border-r-0 [&:nth-last-child(-n+2)]:border-b-0 md:[&:nth-last-child(-n+6)]:border-b-0 transition-all duration-300 ease-out hover:bg-black-5/50 dark:hover:bg-white-5/50 cursor-pointer overflow-hidden min-h-[217px]"
            >
