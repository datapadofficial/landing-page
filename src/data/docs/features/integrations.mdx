...
<StepItem title="Enterprise Security">All integrations use enterprise-grade security with OAuth 2.0, encrypted connections, and role-based access controls. Your data never passes through our servers during sync.</StepItem>
