...
<InfoItem title="How is AI Chat different from regular chatbots?">AI Chat is specifically trained for data analysis and understands business context, statistical concepts, and analytical workflows. Unlike general chatbots, it can perform complex calculations, generate professional visualizations, and provide statistically valid insights from your actual business data.</InfoItem>

<InfoItem title="Can AI Chat remember context from previous conversations?">
Yes! AI Chat maintains conversation history and context throughout your session. It remembers previous queries, definitions you've established, and ongoing analysis threads, allowing for natural follow-up questions and iterative data exploration.
</InfoItem>

<InfoItem title="What types of questions work best with AI Chat?">
AI Chat excels at business questions like "Why did sales drop last month?", "Which marketing channel has the best ROI?", or "Show me customer retention by segment." It understands comparative questions, trend analysis requests, and hypothesis testing scenarios.
</InfoItem>

<InfoItem title="How accurate are the statistical analyses provided?">AI Chat uses established statistical methods and provides confidence intervals, significance testing, and data quality assessments. While highly accurate, we recommend reviewing critical business decisions with your team and validating important findings through multiple analytical approaches.</InfoItem>
