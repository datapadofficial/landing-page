...
_"Una manzana podrida puede estropear todas las demás en la canasta de frutas."_
...
_ARPU = Ingresos recurrentes mensuales / Número de clientes activos_
...
_Crecimiento de ventas mensuales = \{(Ventas del mes actual - Ventas del mes anterior) / Ventas del mes anterior\} x 100_
...
_CLV = (TM x OV x GM x LT) / Número total de clientes para el período_
...
_Tasa de Churn = (Clientes Perdidos / Número total de clientes al inicio del período) X 100_
...
_Duración promedio del ciclo de ventas = Número total de días para cerrar todas las ventas / Número total de nuevos negocios_
...
_Oportunidad de Venta = Valor de Venta X Valor de Oportunidad_
...
_Cumplimiento de cuota = Número de negocios cerrados o ingresos en un período determinado / Cuota para ese período_
...
_Valor promedio de compra = Ventas totales / Número de transacciones_
...
_Relación de leads a ganancia = Número total de ventas / Número total de leads_
...
_CAC = Total de dinero gastado en marketing / Número de clientes adquiridos_
...
_ROI de Marketing = (Ingresos por ventas - Costo de marketing) / Costo de marketing_
...
_ROAS = Total de ingresos generados a partir de campañas publicitarias / Total de dinero gastado en anuncios_
...
_Tasa de Rebote = Sesiones de una sola página / Total de sesiones_
...
_Tasa de Conversión de Página de Destino = (Número de conversiones durante un período / Total de visitantes durante el mismo período) X 100_
...
_Capital de Trabajo = Activos actuales - Pasivos actuales_
...
_Tiempo de Ciclo de Cumplimiento de Pedido = Tiempo de Ciclo de Origen + Tiempo de Ciclo de Producción + Tiempo de Ciclo de Entrega_
...
_Ciclo de Conversión de Efectivo = DIO + DSO - DPO_
...
_Tasa de Inactividad de la Máquina = (Cantidad de tiempo que el equipo está inactivo / Tiempo operativo planificado) x 100_
...
_eNPS = % de Promotores - % de Detractores_
...
_Tasa de Retención de Clientes = \{(CE - CN) / CS\} X 100_
...
_CSAT = Número de clientes felices (personas que respondieron con 9,10) / Número total de encuestados_
...
_Tiempo Promedio de Resolución = Tiempo total de resolución para todos los tickets resueltos / Número total de tickets resueltos_
...
_NPS = (% de promotores - % de detractores)_
...
_CES = ( Número de respuestas con 5,6,7 / no. de respuestas) X 100_
...
_Margen de Beneficio Neto = (Ingreso Neto / Ingresos) X 100_
...
_Margen de Beneficio Bruto = (Ventas netas - COGS) / Ventas netas x 100%_
...
_Tasa de Rotación de Inventario = (Costo de Bienes Vendidos / Inventario Promedio) X 100_
...
_DE = (Deudas a corto plazo + Deudas a largo plazo) + otros pagos / Capital de los accionistas_
...
_AR = Ventas netas a crédito / Promedio de cuentas por cobrar_
