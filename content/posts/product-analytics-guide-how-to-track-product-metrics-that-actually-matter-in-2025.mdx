...
- Request data from analytics team
...
- Drill down with conversational queries

- Receive proactive alerts about changes
...
*Want to experience the future of product analytics? *[*Get started with Datapad*](https://datapad.io/)* and ask your first question in seconds, not days.*