...
Like the example above, there are numerous KPIs that you might want to measure for different departments of your business *(more on this later)*.
...
[KPIs and OKRs](https://www.datapad.io/blog/kpis-vs-okrs) are two completely different chapters of the same book- *performance measurement*. While they might overlap in some places, each is set out for a unique purpose.
...
*CSAT = Number of 4 & 5 respondents / Total no. of respondents X 100*
...
For example, if your goal is to ***‘Get 100 new sign-ups in November,’*** the ideal KPI to track here is the ***‘number of sign-ups.’ ***Other supporting KPIs might be conversion rate, bounce rate, CAC, and many more.
